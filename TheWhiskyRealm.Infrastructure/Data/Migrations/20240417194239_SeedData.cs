        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isApproved = table.Column<bool>(type: "bit", nullable: false, comment: "The state of the whisky."),
                    PublishedBy = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "The Id of the user who published the whisky, if not added by Administrator."),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "77af610e-3202-4bea-8d5c-c20c07f7effe", "3882b86e-4ce3-49e6-83a1-a0294c57a8ff", "WhiskyExpert", "WHISKYEXPERT" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1cf4a321-6128-459e-8e4e-e4615c85d30f", 0, "62e3d22f-d189-437d-ad9f-b3503055560a", new DateTime(2004, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "noToAlcohol@gmail.com", true, true, null, "NOTOALCOHOL@GMAIL.COM", "NOTOALCOHOL@GMAIL.COM", "AQAAAAEAACcQAAAAEO9XFvZBpWH91pTgHMU8AVv2OzpI9AFPyzf4qbGVjOyYyHQ/QM3iQz7rloGQJvwZmA==", null, false, "be5cb855-17de-468e-9a58-e134866f46ec", false, "noToAlcohol@gmail.com" },
                    { "7dfb241e-f8a5-4ba4-a5aa-5becf035c442", 0, "e68811c2-8bf0-455c-8677-e881cdd4610e", new DateTime(1995, 10, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "sober@gmail.com", true, true, null, "SOBER@GMAIL.COM", "SOBER@GMAIL.COM", "AQAAAAEAACcQAAAAEAxX+sgCqY393JDubU9/ZRhO0rkmNbUgrHeQyBSuWSO6qNNlHi87gPyTSx4Ok8Gp6w==", null, false, "9f75312a-360c-485f-b0a7-7c5f1e865891", false, "sober@gmail.com" },
                    { "bd6bbdc1-dc81-4d8d-82ad-e9cb3d393ce4", 0, "57a15255-ba81-48f7-b990-06cdd4618f0f", new DateTime(1994, 9, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "test@gmail.com", true, true, null, "TEST@GMAIL.COM", "TEST@GMAIL.COM", "AQAAAAEAACcQAAAAELKOoGaxyGn8X0gBaF1ZYba6Zrc/bqWNn1zQvDM9tnR6LxiEdZb/6hDbpSlHWhEkeQ==", null, false, "5d5a77ac-4f57-4561-9e3f-fb68292f65b8", false, "test@gmail.com" },
                    { "f99c5e20-d91e-4a5e-9b73-fdb38b89ffc3", 0, "e42a99fa-14b0-4cd2-b594-b929f105e9ee", new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", true, false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEBRj/iLVSBDBlwehjeZjiiQCiVaPy7xeWY5jXfo2LHx+4evLiih4hICBnzypwgfU3Q==", null, false, "6c1f43a9-d6ee-4a7a-bdf4-00167dda3bb0", false, "admin@gmail.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "77af610e-3202-4bea-8d5c-c20c07f7effe", "7dfb241e-f8a5-4ba4-a5aa-5becf035c442" },
            ...
            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "Id", "ApplicationUserId", "ArticleId", "Content", "PostedDate", "UserId" },
                values: new object[,]
                {
                    { 1, null, 1, "Great article! I learned a lot about the whisky types.", new DateTime(2024, 3, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "1cf4a321-6128-459e-8e4e-e4615c85d30f" },
                    { 2, null, 1, "I completely agree with your list! Can't wait to try these whiskies.", new DateTime(2024, 3, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "bd6bbdc1-dc81-4d8d-82ad-e9cb3d393ce4" },
                    { 3, null, 3, "Auchentoshan Three Wood is one of the my favourite whiskies!", new DateTime(2024, 4, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "bd6bbdc1-dc81-4d8d-82ad-e9cb3d393ce4" },
                    { 4, null, 3, "In some aspect i agree with you, but overall i don't!", new DateTime(2024, 4, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "1cf4a321-6128-459e-8e4e-e4615c85d30f" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Join us for an evening of whisky tasting and discovery.", new DateTime(2024, 3, 25, 21, 0, 0, 0, DateTimeKind.Unspecified), "7dfb241e-f8a5-4ba4-a5aa-5becf035c442", 25.99m, new DateTime(2024, 3, 25, 18, 0, 0, 0, DateTimeKind.Unspecified), "Whisky Tasting Evening", 5 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "bd6bbdc1-dc81-4d8d-82ad-e9cb3d393ce4" }
                });
